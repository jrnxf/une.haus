    ...
    <>
      ...
      <div className="mx-auto w-full max-w-3xl p-4">
        <div className="prose prose-sm prose-neutral dark:prose-invert max-w-none">
          ...
          <p>
            We display a count of who's currently active on the site. For
            logged-in users, we store a "last seen" timestamp on your account
            that updates while you're browsing. Your name and avatar are visible
            to other users in the "online" indicator.
          </p>
          <p>
            For anonymous visitors (not logged in), we use your IP address (from
            standard proxy headers) to count unique visitors. IP addresses are
            held in server memory only — they are not written to the database,
            not logged, and are automatically discarded after 30 seconds of
            inactivity or when the server restarts.
          </p>
