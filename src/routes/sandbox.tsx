...
const pairedColors = [
  ...
  { name: "sidebar-primary", bg: "var(--sidebar-primary)", fg: "var(--sidebar-primary-foreground)" },
  { name: "sidebar-accent", bg: "var(--sidebar-accent)", fg: "var(--sidebar-accent-foreground)" },
];
    ...
    <div className="mx-auto w-full max-w-4xl p-4 md:p-6">
      <div className="flex flex-col gap-6">
        ...
        <Section title="tabs">
          ...
          <div>
            <p className="text-muted-foreground text-xs mb-2">underline variant</p>
            <Tabs defaultValue="a">
              ...
              <TabsPanel value="a">
                <p className="text-muted-foreground text-sm p-4">alpha content</p>
              </TabsPanel>
              <TabsPanel value="b">
                <p className="text-muted-foreground text-sm p-4">beta content</p>
              </TabsPanel>
            </Tabs>
          </div>
        </Section>
        ...
        <Section title="link card">
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            ...
            <LinkCard.Root href="/sandbox">
              ...
              <LinkCard.Content>
                <LinkCard.Description>
                  Cards can include arbitrary content between the description and
                  the call-to-action.
                </LinkCard.Description>
