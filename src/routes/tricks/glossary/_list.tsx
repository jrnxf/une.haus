        ...
        <div className="flex items-center gap-2">
          ...
          <Tooltip>
            ...
            <TooltipContent side="right" className="space-y-1">
              <p>
                <span className="font-semibold">elements</span> represent the
                building blocks of a trick. adding or removing an element
                transforms a trick into a new one.
              </p>
              <p>
                <span className="font-semibold">modifiers</span> describe the
                different ways you can perform a trick. they change the way the
                trick is done, but not signifcantly enough to warrant a new
                entry.
              </p>
            </TooltipContent>
          </Tooltip>
