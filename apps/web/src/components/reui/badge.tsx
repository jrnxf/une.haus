...
const badgeVariants = cva(
  "focus-visible:ring-ring focus-visible:ring-offset-background relative inline-flex w-fit shrink-0 items-center justify-center rounded-sm border border-transparent font-medium whitespace-nowrap transition-shadow outline-none focus-visible:ring-2 focus-visible:ring-offset-1 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*=size-])]:size-3",
  {
    variants: {
      variant: {
        default: "bg-primary text-primary-foreground",
        outline: "border-border dark:bg-input/32 bg-transparent",
        ...
        "primary-light":
          "bg-primary/10 text-primary dark:bg-primary/20 border-none",
        "warning-light":
        ...
        "destructive-light":
          "bg-destructive/10 text-destructive-foreground dark:bg-destructive/20 border-none",
        "invert-light":
          "bg-invert/10 text-foreground dark:bg-invert/20 border-none",
        "focus-light":
