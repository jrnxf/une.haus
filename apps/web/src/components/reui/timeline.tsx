...
function TimelineIndicator({
  ...
  const defaultProps = {
    "aria-hidden": true,
    className: cn(
      "border-border group-data-completed/timeline-item:border-foreground/20 absolute size-4 rounded-full border-2 group-data-[orientation=horizontal]/timeline:-top-6 group-data-[orientation=horizontal]/timeline:left-0 group-data-[orientation=horizontal]/timeline:-translate-y-1/2 group-data-[orientation=vertical]/timeline:top-0 group-data-[orientation=vertical]/timeline:-left-6 group-data-[orientation=vertical]/timeline:-translate-x-1/2",
      className,
    ),
...
type TimelineItemProps = useRender.ComponentProps<"div"> & {
  step: number
}
...
function TimelineItem({
  ...
  const defaultProps = {
    className: cn(
      "group/timeline-item has-[+[data-completed]]:**:data-[slot=timeline-separator]:bg-foreground/20 relative flex flex-1 flex-col gap-0.5 group-data-[orientation=horizontal]/timeline:mt-8 group-data-[orientation=horizontal]/timeline:not-last:pe-8 group-data-[orientation=vertical]/timeline:ms-8 group-data-[orientation=vertical]/timeline:not-last:pb-6",
      className,
    ),
