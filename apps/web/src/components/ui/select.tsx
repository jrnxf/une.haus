  ...
  return (
    ...
    >
      ...
      <SelectPrimitive.Icon
        render={
          <ChevronDownIcon className="text-muted-foreground pointer-events-none size-4 transition-transform duration-150 group-data-[popup-side=top]/select-trigger:rotate-180" />
        }
      />
    </SelectPrimitive.Trigger>
  )
